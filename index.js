...
document.getElementById('game').addEventListener('keyup', event => {
    ...
    if (isSpace) {
        ...
        currentWord.nextElementSibling.firstElementChild.classList.add('current');
    }
    ...
    if (isBackspace) {
        if (currentLetter && isFirstLetter) {
            ...
            currentLetter.classList.remove('current');
            currentWord.previousElementSibling.lastElementChild.classList.add('current');
            currentWord.previousElementSibling.lastElementChild.classList.remove('incorrect');
            currentWord.previousElementSibling.lastElementChild.classList.remove('correct');
        }
        if (currentLetter && !isFirstLetter) {
            currentLetter.classList.remove('current');
            currentLetter.previousElementSibling.classList.add('current');
            currentLetter.previousElementSibling.classList.remove('incorrect');
            currentLetter.previousElementSibling.classList.remove('correct');
        }
